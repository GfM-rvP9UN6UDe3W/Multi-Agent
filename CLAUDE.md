...
| `docs/specs/0017-audit-corrections.md` | Audit corrections: rule paths checked at admission, retry digests, revise on stopped sessions, handoff expiry timer (rc.11) |
