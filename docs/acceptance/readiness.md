...
| Public publication | Closed. 0.1.0 of the npm packages was published on 2026-09-23, 0.1.2 on npm, PyPI and GitHub Releases on 2026-09-24, and 0.1.3 on 2026-09-25, each through the release workflow after the owner approved it; the installation from the registries passed for both (SPEC-0021 P04) | Later releases follow the [release guide](../release/publishing.md). Announcing the project is a separate launch step (SPEC-0021 L01). |
