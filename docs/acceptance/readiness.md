...
Updated 2026-09-21 for SPEC-0012; the publication gate was updated on 2026-09-24. This ledger distinguishes implemented SDK behavior, real native runtime behavior with scripted responses, and deployment evidence that those tests cannot supply.
...
| Public publication | Closed. 0.1.0 of the npm packages was published on 2026-09-23, and 0.1.2 on npm, PyPI and GitHub Releases on 2026-09-24, through the release workflow after the owner approved it; the installation from the registries passed (SPEC-0021 P04) | Later releases follow the [release guide](../release/publishing.md). Announcing the project is a separate launch step (SPEC-0021 L01). |
