...
| F16 | Full Node/Python/type/format/generated checks; measured 1k/10k retained-task capacity report; finite host/session/queue limits | Published-revision CI ran and exposed failures; SPEC-0011 fixes require a new remote run. Defaults are not production capacity claims |
